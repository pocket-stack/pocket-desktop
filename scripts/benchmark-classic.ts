...
try {
  ...
  const report = {
    schemaVersion: 1,
    label: "Pocket Desktop classic baseline",
  ...
  const markdown = `# Pocket Desktop classic baseline (${date})

**Measured source:** Pocket Desktop \`${productCommit}\`, PocketJS \`${pocketJsCommit}\`  
