...
export interface DesktopTheme {
  ...
  /** File-manager toolbar (sheru's toolbar shape): navigation buttons, an
...
// Aqua is glass over brushed light gray. The reference is sheru's aqua theme
// (packages/themes/src/aqua): a glossy white-to-gray title bar with the
// traffic lights on the LEFT, a matte inactive state, a blue-to-deeper-blue
...
// gradient sheru uses. Menus hang from the screen bar with square top
...
export const AQUA_THEME: DesktopTheme = {
  ...
  // cluster, which restores the colors (the era rule sheru's theme keeps).
